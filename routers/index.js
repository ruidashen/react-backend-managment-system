  ...
  router.get("/manage/user/list", (req, res) => {
    UserModel.find({ username: { $ne: "admin" } })
      ...
      .catch(error => {
        ...
        res.send({
          status: 1,
          msg: "getting user list error, please try again"
        });
      });
  });
...
router.get("/manage/category/list", (req, res) => {
  ...
  CategoryModel.find({ parentId })
    ...
    .catch(error => {
      ...
      res.send({
        status: 1,
        msg: "adding category list error, please try again"
      });
    });
});
...
router.get("/manage/category/info", (req, res) => {
  ...
  CategoryModel.findOne({ _id: categoryId })
    ...
    .catch(error => {
      ...
      res.send({
        status: 1,
        msg: "getting category info error, please try again"
      });
    });
});
...
router.post("/manage/product/add", (req, res) => {
  ...
  ProductModel.create(product)
    ...
    .catch(error => {
      ...
      res.send({
        status: 1,
        msg: "adding product error, please try again",
        error
      });
    });
});
...
router.get("/manage/product/search", (req, res) => {
  ...
  ProductModel.find(contition)
    ...
    .catch(error => {
      ...
      res.send({
        status: 1,
        msg: "searching product list error, please try again"
      });
    });
});
...
router.post("/manage/role/add", (req, res) => {
  ...
  RoleModel.create({ name: roleName })
    ...
    .catch(error => {
      ...
      res.send({
        status: 1,
        msg: "adding role error, please try again",
        error
      });
    });
});
